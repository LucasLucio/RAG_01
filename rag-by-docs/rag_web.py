...
def simple_rag(question):
    ...
    persistance_directory = "./coft_chroma_db"
    ...
    system_prompt = (
        "Considere que você é um assistente de perguntas e respostas."
        "Use os seguintes pedaços de contexto recuperado para responder as solicitações realizadas."
        "Se não souber as respostas diga que não é possível realizar a operação desejada."
